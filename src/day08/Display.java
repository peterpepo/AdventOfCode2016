...
public class Display {
    ...
    private Character[] getColumn(int columnId) {
    ...
    private void setColumn(int columnId, Character[] columnChars) {
        for (int i = 0; i < displayContent.length; i++) {
            displayContent[i][columnId] = columnChars[i];
        }
    }

    private Character[] getRow(int rowId) {
    ...
    private void setRow(int rowId, Character[] rowChars) {
        for (int j = 0; j < displayContent[rowId].length; j++) {
            displayContent[rowId][j] = rowChars[j];
        }
    }

    private void setAll(Character c) {
        for (int i = 0; i < displayContent.length; i++) {
